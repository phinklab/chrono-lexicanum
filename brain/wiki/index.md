...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [project-state.md](./project-state.md)           | "Where are we now": phase, what's running, next likely brief. Post-Merge-Koordinations-Pass post-PR-107 (2026-05-27): Resolver-Loop 5 Wellen gemergt (Pässe 11–15, `ssot-hh-003..030`, +274 HH-Bücher) — **DB 585 → 859 = Korpus datenkomplett (565 W40K + 294 HH)**. Resolver-Loop emittiert `all-complete`; fünf clean Two-Domain-Pässe in Folge, kein `## Needs decision`-Stop. Cross-Era-ADR über den vollen HH-Korpus gehärtet. EXPECTED_RANGES.locations.max in Pass 15 1100 → 1500 (Pass-14-forecasted re-tune). Nächster Architekten-Brief: HH-Konsolidierungs-Pass (Maschinerie aus Brief 098 existiert). | 2026-05-27 |
| [open-questions.md](./open-questions.md)         | Items the next architect brief must address. Post-Merge-Koordinations-Pass post-PR-107 (2026-05-27): Resolver-Loop 5 HH-Wellen gemergt, HH-Domäne datenkomplett — keine OQ-Schließung, keine neue numerierte OQ. HH-Restwellen-Punkt (operativ, kein Brief) als erledigt geprunt. Offene Queue unverändert: OQ (3) Hand-Check-Workflow, OQ (13) Crawl-Simplification-Sichtung. | 2026-05-27 |
...
| [pipeline-state.md](./pipeline-state.md)         | Phase-3 pipeline detail: V1 legacy + V2 SSOT authority path + resolver layer. Post-PR-107 (2026-05-27): Resolver-Loop 5 Wellen (Pässe 11–15, `ssot-hh-003..030`) appliziert — **DB 585 → 859 = Korpus datenkomplett** (565 W40K + 294 HH), Loop emittiert `all-complete`, EXPECTED_RANGES.locations.max 1100 → 1500. | 2026-05-27 |
