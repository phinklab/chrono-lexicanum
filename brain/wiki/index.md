...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [project-state.md](./project-state.md)           | "Where are we now": phase, what's running, next likely brief. Post-Merge-Koordinations-Pass post-PR-108 (2026-05-27): Brief 102 (HH-Konsolidierungs-Pass) gemergt — 23 Kandidaten → 2 Character-Merges (`merir_astelan→astelan` cross-era lore-deep + `sharrowkyn→nykona_sharrowkyn` same-era mechanical), 21 No-Merges, 0 Flagged. Cross-era-anchor-breach Aggregator-Tripwire 0 Treffer = positive Brief-100-ADR-Validation. characters 491→489, work_characters 1992→1997, `EXPECTED_RANGES.characters.max 2200→2500`. `verify-pass.ts`-Out-of-Range-Bolt-on landed (Brief 101 § Open questions gefaltet); Pass-2-Lauf = 0. **Brief-094-§-Cadence-Bogen geschlossen.** **Korpus datenkomplett + konsolidiert (859/859).** Nächster Architekten-Brief: drei Kandidaten — (a) Audit-Cockpit-Drift/Gap-Sweep (Top-Empfehlung), (b) Phase-3-Seal-Brief, (c) Aufmerksamkeit zurück zu Brief 096. | 2026-05-27 |
| [open-questions.md](./open-questions.md)         | Items the next architect brief must address. Post-Merge-Koordinations-Pass post-PR-108 (2026-05-27): Brief 102 (HH-Konsolidierungs-Pass) gemergt — keine OQ-Schließung (Pass 2 ist Maschinerie-Lauf ohne Architektur-Call; alle fünf Brief-102-§-Open-questions im Impl-Report beantwortet), keine neue numerierte OQ. Offene Queue unverändert: OQ (3) Hand-Check-Workflow, OQ (13) Crawl-Simplification-Sichtung. Watch-Items im § What's open in `project-state.md`. | 2026-05-27 |
...
| [pipeline-state.md](./pipeline-state.md)         | Phase-3 pipeline detail: V1 legacy + V2 SSOT authority path + resolver layer. Post-PR-108 (2026-05-27): Brief 102 (HH-Konsolidierungs-Pass) gemergt — Full-Corpus W40K + HH konsolidiert (23 Cluster → 2 Character-Merges, 21 No-Merges, 0 Flagged); characters 491→489, work_characters 1992→1997, `EXPECTED_RANGES.characters.max 2200→2500`. `verify-pass.ts`-Out-of-Range-Bolt-on landed. Multi-Range-Loader-Normalisierung. **Brief-094-§-Cadence-Bogen geschlossen.** | 2026-05-27 |
