...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [project-state.md](./project-state.md)           | "Where are we now": phase, what's running, what's open, next likely brief. **Stand 2026-06-12 (großer Rollup-Pass):** Korpus 889, 4 Podcast-Shows (~1094 Episoden), Timeline-Datenfundament + Cinematic-`/timeline`, `/compendium` + `/archive` + `/ask` shipped, Deep-Review-Zyklus (140/141/144 → 147/148) umgesetzt, Polish-Sweep 150 shipped, Site hinter Preview-Gate. Historie der früheren Snapshots → `log.md` + git. | 2026-06-13 |
| [open-questions.md](./open-questions.md)         | Items the next architect brief must address (Queue klein halten, 3–5). Aktuell: **(16)** Timeline-Folgen aus impl 137 (db:rebuild-Tail, primaryEraId-Placeholder, Atlas-Events) + **(17)** Deep-Review-Rest aus 147 (Preview-Gate vs. Maschinen-Endpoints, CSP, `/buecher`, FilterRail, `/buch`-SSG, `REVALIDATE_TOKEN`). (15) Compendium 2026-06-12 geschlossen → Boards. | 2026-06-12 |
...
| [log.md](./log.md) | Append-only operation log (chronological history of Brain edits) | 2026-06-12 |
| (this file) | Master catalog | 2026-06-12 |
