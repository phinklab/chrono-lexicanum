...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [project-state.md](./project-state.md)           | "Where are we now": phase, what's running, next likely brief. **Post-PR-118 / Brief 104 alias-aware-drift (2026-06-01):** Brief 104 (Product) gemergt — geteiltes `src/lib/aliases/`-Modul + drei-Zustands-Drift, `drift_works` 380 → 0 (alle 500 Drift-Junctions sind registrierte Edition-Renames); **Edition-Rename-Alias-Cluster-Watch-Item geschlossen** (korrigierte Prämisse: App-Schicht-Hebel, nicht Daten). Vier next-brief-Folgen (leerer `?audit=drift`-Bucket, Alias-Klasse-always-on, `resolveSurfaceForm`-Verdrahtung = Brief 109 Step 3, maintainer-Visual-Pass). Keine OQ-Bewegung. **Post-Brief-107 (2026-05-30):** Brief 107 (`full-rebuild-restore-wiring`, Batches) gemergt → Watch-Item Full-Rebuild-Restore-Wiring **geschlossen, Cluster A komplett** (neuer confirm-gegateter `db:rebuild`-Orchestrator macht `apply:audiobook-narrators` zum deterministischen Tail der SSOT-Reset-Sequenz; `--verify` = exakte `(workId,personId,role)`-Mengen-Gleichheit, Sidecar-abgeleitet; `apply-override.ts` unangetastet; `db:seed` off-path). Keine OQ-Bewegung. **Post-PR-112 + post-PR-113 (2026-05-30):** Brief 105 Daten-Pass (Hörbuch-Credits — 66 Bücher, 88 `work_persons`-Audio-Rollen, 29 Performer, P1-Durability-Fix) gemergt + Cowork-reviewt (akkurat/stabil/sinnvoll); PR #113 (Chronicle/Ask-Redesign = Brief-096 G+H) gemergt, Sichtung + 096-Status offen; Brief-105-UI-Pass offen; neues Watch-Item Full-Rebuild-Restore-Wiring (`apply:audiobook-narrators` in die Reset-Sequenz). Post-Merge-Koordinations-Pass post-PR-110 + post-PR-111 (2026-05-28): Product-Strang gemergt — PR #110 (Brief 096 Phasen A–F + Map/Atlas-Inventories + zwei Map-Polish-Followups, 147 Files) + PR #111 (Brief 103 UI-Pass `Audio-Drama-Daempfung + Drift-Tie-Group-Sub-Sort`, 5 Files). Brief 103 jetzt vollständig `status: implemented` (beide Hälften — Daten via PR #109, UI via PR #111); Brief 096 bleibt `status: open` (Phasen G + H deferred, lokal-iterativ im Product-Worktree). Top-Empfehlung im post-PR-110/111-Stand war der Edition-Rename-Alias-Cluster-Brief — **inzwischen als Brief 104 erledigt** (drift_works 380→0, siehe Post-PR-118-Lead oben). **Korpus bleibt datenkomplett + konsolidiert (859/859).** Disziplin-Befund: NNN=098/099-Collision der zwei Product-Strang-Map-Polish-Files für nächsten Sessions-Archive-Sweep markiert. **Post-Brief-111 (2026-06-02):** doc-only-Teilmenge gemergt (`2c9af45`) — 7 ungekoppelte Paare archiviert, 098/099-Collision → 115/116 aufgelöst, Frontmatter-Schema-Regression der always-read-Files gefixt. **Post-Brief-117 (2026-06-02):** Tooling-Files-Relocation gemergt — 6 script-gekoppelte Tooling-Files (2 Loop-Logs + 4 Runbooks) raus aus `sessions/` → `scripts/logs/` + `scripts/runbooks/`, Pfad pro Runner zentralisiert, 102/107 mit-archiviert. | 2026-06-03 |
| [open-questions.md](./open-questions.md)         | Items the next architect brief must address. **Post-impl-137 (2026-06-11):** neue OQ (16) — drei Timeline-Folgethemen aus impl 137 (db:rebuild wischt Timeline-Daten weg → Interim: `apply:timeline` nach jedem Rebuild; primaryEraId-M41-Placeholder auf ~859 SSOT-Büchern; Atlas-Event-Page-Type). **Post-PR-118 / Brief 104 (2026-06-01):** Brief 104 gemergt — Edition-Rename-Watch-Item geschlossen, `drift_works` 380→0; keine OQ-Schließung, keine neue numerierte OQ. **Post-Brief-107 (2026-05-30):** Brief 107 gemergt — Watch-Item Full-Rebuild-Restore-Wiring geschlossen (Cluster A komplett); keine OQ-Schließung, keine neue numerierte OQ. **Post-PR-112 + post-PR-113 (2026-05-30):** Brief 105 Daten-Pass + PR #113 (Chronicle/Ask) gemergt — keine OQ-Schließung, keine neue numerierte OQ; neue Watch-Items: Full-Rebuild-Restore-Wiring, Brief-105-UI-Pass, PR-#113-Sichtung + 096-Status, 859er-Audiobook-Sweep, Short-Title-Store-Kollisionen. Post-Merge-Koordinations-Pass post-PR-110 + post-PR-111 (2026-05-28): Product-Strang Design-Direction + Brief 103 UI-Pass gemergt — keine OQ-Schließung (beide PRs sind UI-Strang ohne numerierten OQ-Bezug; alle sechs Brief-103-§-Open-questions sind über die zwei Impl-Reports beantwortet — Q1/Q4 im Daten-impl, Q2/Q3/Q5/Q6/Q7 im UI-impl), keine neue numerierte OQ. Offene Queue unverändert: OQ (3) Hand-Check-Workflow, OQ (13) Crawl-Simplification-Sichtung. Watch-Items im § What's open in `project-state.md`: Edition-Rename-Alias-Cluster-Brief (Top-Empfehlung), Sessions-Archive-Sweep + NNN=098/099-Collision-Fix, Brief-096 G+H, /buch/[slug]/audit-Detail-Refinement, site-weite Audio-Drama-Dämpfung, Legacy-Token-Cleanup, Maintainer-Excel-Sweep, Pelago-Tags-Review, Audit-Helper-Snapshot-Persistenz. | 2026-06-11 |
...
| [log.md](./log.md) | Append-only operation log (chronological history of Brain edits) | 2026-06-02 |
| (this file) | Master catalog | 2026-06-02 |
