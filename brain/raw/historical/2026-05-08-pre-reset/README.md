...
snapshot-reason: Pre-Karpathy-reset (brief 049). Top-level README.md was a hybrid pitch + dev-quickstart until the reset; brief 049 slims README to a thin pitch + status + brain pointer + live URL, and routes engineering detail through brain/wiki/. This file preserves the post-048-doc-refresh state for archaeological reference.
canonical-now: README.md (slim) + brain/wiki/onboarding.md (dev quickstart) + brain/wiki/project-state.md (status)
---
