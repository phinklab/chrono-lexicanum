---
snapshot-of: ONBOARDING.md
snapshot-date: 2026-05-08
snapshot-reason: Pre-Karpathy-reset (brief 049). Top-level ONBOARDING.md was the canonical first-time setup doc until the reset; canonical engineering memory now lives in brain/wiki/. This file preserves the post-048-doc-refresh state (TypeScript-pipeline references, 26 manual books, Vercel preview SSO note) for archaeological reference.
canonical-now: brain/wiki/onboarding.md
---
