...
/**
 * Root Suspense fallback (Report — perceived latency). Home (`/`) is the root
 ...
 * files.
 *
 * Static routes (login, /lab/*) do no async work → never suspend → never paint
 * this. Routes that already ship a local loading.tsx (archive, ask, buch/[slug],
