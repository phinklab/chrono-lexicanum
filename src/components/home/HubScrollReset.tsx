 ...
 * Act 1. Browsers natively restore the previous scroll offset on reload (a
 * real F5-after-scrolling, and dev HMR reloads); with mandatory snap, a
 * restored offset parked the page mid-act. We opt this page out of native
