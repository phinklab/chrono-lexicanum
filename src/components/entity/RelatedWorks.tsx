 ...
 * The loader resolves each work's link target (`href`) and parent-show
 ...
 * group renders fully expanded on purpose: a collapsed-by-default long Books
 * list buries the Podcasts/Characters groups below it, and a short popup gains
 * nothing from a click to reveal a handful of items. Pure presentational (no
 * client state); it imports nothing from `@/db` (types are `import type`,
