...
/* SiteLegal — tiny fixed Impressum/Datenschutz links pinned under the media
   player in the bottom-left corner: the desktop immersive surfaces (map,
   timeline, entity pages) carry neither ArchiveFooter nor the burger, so
   this row is the site-wide guarantee that the legal pages stay one click
   ...
   ≤760px, where the player is gone and the burger menu carries the links. */
