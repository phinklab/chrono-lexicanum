 ...
 * alongside SiteMenu. Primary navigation on wide screens: permanently visible
 * title plus a quiet descriptive sublabel per entry, the active route marked
 * by the gold rubric stroke in the margin (CSS ::before). Entries come grouped
 * from navEntries.ts (Session 255): the groups render as bare hairline
 * separators here — the labelled version lives in the burger overlay. On
 * narrow viewports the rail is hidden and the SiteMenu burger overlay takes
 * over — see 46-site-nav.css.
 *
