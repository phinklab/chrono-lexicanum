...
|---|---|---|---|---|---|
| 1 | **F2** | Idee 2 — Doppelkauf-Warner (Containment-Explorer) | — | **Backlog** — Revisit nach den übrigen Runden | Session 235 |
| 2 | **F1** | Idee 1 — Status Imperialis | — | **bauen** | Session 236 |
| 3 | **F3** | Idee 3c — Statistiken („Librarium") | — | **bauen** | Session 237 |
| 4 | **W4** | Idee 4 — Provenienz sichtbar machen | sinnvoll nach F2 (Synergie Confidence-Anzeige) | **Backlog** | Session 238 |
| 5 | W3a | Idee 3a — Charakter-Interaktions-Baum *(Schema)* | — | **bauen** | Session 239 |
| 6 | W3b | Idee 3b — Timeline auf der Map *(umgeplant: drei Zeitkarten + Karten-Timeline, ohne Schema)* | — | **bauen** | Session 240 |
| 7 | W5 | Idee 5 — Podcasts auf der Buch-Detailseite *(Schema)* | — | **Backlog** — Revisit post-launch | Session 240 |
| 8 | W6 | Idee 6 — Size Comparison „Scala Imperialis" *(Schema, Neubau)* | — | **Backlog** — Revisit post-launch | Session 240 |
| 9 | WA | Anhang-Kurz-Triage (7 Ideen) | nach den Hauptideen | **7/7 entschieden** — 1× bauen (Facetten-UI), 4× Backlog, 1× verwerfen, 1× → Runde WL | Session 241 |
| 10 | WP | Perfektions-Kandidaten-Triage (Product + Data, 8 Posten) | nach den Hauptideen | ☐ offen | |
| 11 | WM | Map-UI-Rework — Cartouche/Instrumente revisiten (Journeys + Karten-Timeline + Zeitkarten sind zusammen zu viel fürs heutige UI; Philipp, Session 240) | nach W3b-Bau | ☐ offen | |
...
### F1-Bau — Kickoff-Prompts (Urteil „bauen", Session 236)

Zwei strand-reine Sessions; Reihenfolge B1 → B2 empfohlen (die Seite landet dann mit vollständiger Liste), technisch aber unabhängig. **Timing (Philipp, Session 236):** Die Bau-Sessions starten erst, wenn die restlichen Bewertungsrunden durch sind — mögliche Überschneidungen/Synergien mit späteren Urteilen (z. B. W4-Provenienz auf der /now-Fläche, F3-Statistik-Module) fließen dann in den finalen Zuschnitt ein.
...
Kontext: F1-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 236). Ziel: die „Jetzt"-Kante der Setting-Datierungen schließen, damit die /now-Seite vollständig trägt.
...
Kontext: F1-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 236). Eigene Route (Arbeitsname /now), Seitentitel „Status Imperialis", Sternwarte-Vokabular, hybrid: DB-Module + schlanke kuratierte Prosa im Code.
...
### F3-Bau — Kickoff-Prompt (Urteil „bauen", Session 237)
...
Kontext: F3-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 237). Eigene statische Route (Arbeitsname /statistics), „Librarium"-Vokabular, handgerollte SVG-Charts als Server Components, keine neue Dependency, Interaktivität max. CSS-Hover.
...
### W3a-Bau — Kickoff-Prompt (Urteil „bauen", Session 239)
...
Kontext: W3a-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 239). Abgeleitete Ko-Okkurrenz ohne Schema-Change; kuratierte character_relations und eine eigene Graph-Explorer-Route bleiben bewusste v2-Optionen (bräuchten dann den Brief).
...
### W3b-Bau — Kickoff-Prompts (Urteil „bauen", Session 240)
...
Kontext: W3b-Urteil „bauen" im umgeplanten Zuschnitt (docs/werkstatt-roadmap.md § Runden-Notizen, Session 240). Drei diskrete Kartenzustände: Stufe 1 Pre-Heresy (M30), Stufe 2 Horus Heresy (M31), Stufe 3 = heutige Karte (M41/42). Pins/Planeten bleiben in allen Stufen identisch; nur Zonen und zeitgebundene Instrumente schalten.
...
Kontext: W3b-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 240); setzt W3b-B1 voraus.
...
### WA-Bau — Kickoff-Prompt (Urteil „bauen", Session 241)

**Timing (wie F1/F3/W3a/W3b):** Bau erst, wenn die restlichen Bewertungsrunden (WP, WM, WL) durch sind; gebaut wird vor dem Release (Maintainer-Urteil, Session 241).
...
Kontext: WA-Urteil „bauen" (docs/werkstatt-roadmap.md § Runden-Notizen, Session 241). Die kuratierten Facetten (896/896 Bücher, ~19 Zuweisungen/Buch, 12 Kategorien) werden als kombinierbare Filter-UI im Archiv-Register sichtbar — kein Schema, keine neuen Daten, keine neue Dependency.
