# Werkstatt-Fahrplan — Archiv (erledigte Posten + Urteils-Historie)

> Ausgelagert am 2026-07-24 (Session 263) aus [`werkstatt-roadmap.md`](./werkstatt-roadmap.md), damit der lebende Fahrplan klein bleibt. **Nicht in Sessions einladen** — nur bei Bedarf gezielt nachschlagen. Vollständige ältere Stände (inkl. der Bewertungs-Notizen der Runden 235–241): Git-Historie von `docs/werkstatt-roadmap.md` (PRs #267/#268 ff.).

## Fahrplan — erledigte Posten 1–13
...
| 13 | **S7b** — Player/Chrome/Assets | Qualitätspass | 1–12b abgeschlossen | ✔ 262 |

Die Positionen 3/4 standen bewusst früh, damit Runde 5 (WM) das echte UI beurteilen konnte; die übrigen Bauten (7–11b) waren untereinander unabhängig.
...
| W3a (239) | Charakter-Graph | **bauen → Backlog (2026-07-22)** | Vor Launch zurückgestellt (Maintainer): zu wenig Nutzen für zu viel Arbeit vor dem Rollout. Der Ko-Okkurrenz-v1-Zuschnitt (Modul auf `/character/[slug]`, ohne Schema; kuratierte `character_relations` als v2) liegt entscheidungsreif im archivierten Prompt § 10 — Revisit post-launch. |
...
## Prompts der erledigten Posten (1–12b)

> Historisch — die zugehörigen Sessions sind gelaufen. Nur nachschlagen, wenn eine Folge-Session den damaligen Zuschnitt braucht (z. B. W3a-B1 § 10 beim Post-Launch-Revisit des Charakter-Graphen).
...
> **Backlog seit 2026-07-22 (Maintainer), Revisit post-launch.** Der folgende Prompt bleibt als entscheidungsreifer Zuschnitt erhalten.
...
## Backlog-Prompt · W3b-B3 — Zeitstrahl (Kickoff, Roast-Fragephase)

> **Backlog, nicht in der Vor-Launch-Queue** (Urteil Session 247). Revisit auf Maintainer-Zuruf, frühestens post-launch.
...
- UI: Wo sitzt der Strahl (Era-Platte top-center vs. Bottom — Kollision mit Tour-Cards/Sheet), wie sieht er auf ≤640px aus, wie viel Chrome verträgt die Karte noch?
...
UI-Abnahme durch mich im Browser, keine Headless-Loops. Branch: codex/product-map-zeitstrahl. Kein Commit/PR, bis ich „fertig" sage. Danach Backlog-Zeile in docs/werkstatt-roadmap.md nachführen.
```
