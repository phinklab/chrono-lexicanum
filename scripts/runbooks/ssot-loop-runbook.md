...
- **Surface-Form-Treue, kein Pre-Resolving.** Namen exakt wie in den Quellen — kein Slugify, kein Canonical-ID-Lookup. „Sons of Horus" bleibt „Sons of Horus". Resolving in canonical Reference-Tables passiert separat im Resolver-Loop (Brief 094) — entkoppelt vom SSOT-Loop, eigener headless Wrapper über W40K-Wellen.
...
- **Cumulative books in authority:** N
- **CC model:** <model>
...
- Complete: ein Commit = { Log-Append } (keine Override-Datei).
