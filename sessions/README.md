...
> **Maintainer-Bedienung in einem Satz:** Brief 074 (Resolver-Pass 3) ist gemerged (PR #57, `6ac4295`); Wiki-Hygiene-Pass post-074-impl ist durch (ADR `decisions/why-cc-direct-curation.md`, OQ1 + OQ2-(c) als moot/deferred). Nächster operativer Schritt nach Maintainer-Wahl: Loop-Re-Trigger für `ssot-w40k-016` (skip-50-stop-Marker bis zur 200er-Pause), Cockpit-Refinement (freq-/confidence-Sort in Drift-Pille), oder OQ6 Hardcover-Rating-Promotion.
