...
> **Maintainer-Bedienung in einem Satz:** Resolver-Apply (069) und Faction-Policy-Hygiene (070) sind abgeschlossen; `factions.json` ist Lore-korrekt geparented, Browse-Root-Policy + Pre-Apply Parent-Hygiene-Check im Runbook stehen. Brief **061** (Loop) kann pro `/clear` weiterlaufen, nächste Iteration wäre `ssot-w40k-006`.
