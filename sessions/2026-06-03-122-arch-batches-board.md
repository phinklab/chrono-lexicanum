...
| B3 | Entity-Blurbs: F/C/W je 1–2 Satz per Websuche als Seed/Override-Daten. Kurz, faktisch, kein Lore-Essay | ☑ erledigt (143 Blurbs kuratiert + Sweep-Machinery; Full-Coverage ~838 Rest via `scripts/runbooks/entity-blurbs-full-run.md` als Folge-Sweep) |
