...
| B2 | Buch-Kuratierung: Faction add/remove + Hand-Fixes via Override; Content-Warnings aus Daten/Schema; Override-Format definieren (was auto-rollt / Augen braucht). Spec: Brief [149](./2026-06-12-149-arch-curation-foundation.md) | ☐ (Brief liegt) |
