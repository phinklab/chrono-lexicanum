...
| P14 | Map-Komplett-Überarbeitung | ☑ erledigt (Dreiteiler): Teil A Daten = [174](./2026-07-02-174-arch-map-ssot-reconciliation.md) + Teil A.2 = [183](./2026-07-02-183-arch-map-worlds-daten-pass.md) (Batches, `map-worlds-v2`, 1054 Welten) + **Teil B UI = Brief 178** (Product, Plan-Mode; impl `2026-07-05-178-impl-map-cartographer.md`, **gemergt 2026-07-06** — Cartographer-Neubau, `/map` statisch, alte Disc gelöscht, P15 eingefaltet, K11 gelöst). Offene Mini-Follow-ups: Direction-Panel einbrennen, Episoden-Anker, Zoneneditor, Blurb-Filler 24 |
