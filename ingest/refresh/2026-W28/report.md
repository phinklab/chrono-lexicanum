...
_Generated 2026-07-08T19:16:11.219Z by `refresh:check`. Detection only — nothing has been written to the DB._

## Summary

- **Books:** 2 new, 0 pending, 0 to review (source: ok)
- **Podcasts:** 4 new episode(s) — 4 ok, 0 failed, 0 skipped
...
Committed 154, fetched 155, **1 new since 2026-07-03** (154 before cursor ignored).

- _2026-07-06_ Episode 146 - Word Bearers pt 3 - Heresy is a go, but Erebus and Lorgar have some different ideas of next steps — https://the40klorecast.com/

### ✅ Adeptus Ridiculous (`adeptus-ridiculous`, rss)

Committed 367, fetched 368, **1 new since 2026-07-03** (367 before cursor ignored).

- _2026-07-08_ Cypher: The Fallen Angel Who Walked to the Golden Throne \| Warhammer 40k Lore
